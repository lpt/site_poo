...
<div class="form-group">
  <p>
    ...
    <label>Titre </label><br /><input type="text" name="titre" value="<?= isset($news) ? $news['titre'] : '' ?>" /><br />
 
    <?= isset($erreurs) && in_array(\Entity\News::CONTENU_INVALIDE, $erreurs) ? 'Le contenu est invalide.<br />' : '' ?>
    <label>Contenu </label><br /><textarea rows="8" cols="60" name="contenu"><?= isset($news) ? $news['contenu'] : '' ?></textarea><br />
<?php
